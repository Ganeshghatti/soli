...
export default function Navbar() {
  ...
  return (
    <nav
      id="navbar"
      className="absolute top-0 left-0 w-screen flex justify-around lg:justify-between md:justify-between items-center py-6 lg:px-8 z-50 md:px-6 pl-16"
    >
      ...
      <div className="flex gap-12 items-center md:hidden">
        ...
        <img src="./assets/navbarbutton.png" className="cursor-pointer" alt="click here" />
      </div>
    </nav>
  );
}

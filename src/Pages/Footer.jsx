    ...
    >
      <div className="flex w-full justify-between">
        ...
        <div className="footer-div flex flex-col gap-4 w-3/4 justify-center items-start">
          ...
          <img src="./assets/footerart.png" alt="" className="w-4/5 md:hidden"/>
        </div>
      </div>

      <div className="w-full flex justify-between md:flex-col px-8 md:px-2">
        <p className="footer-copyright md:hidden">
          Copyright ©2024 Soli. All rights reserved.
        </p>
        <p className="footer-title hidden md:block">Join us in this adventure</p>
